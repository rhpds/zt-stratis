...
.list fs
image::../assets/images/listfs.png[list fs]
...
.renamed
image::../assets/images/renamedfs.png[renamed]
...
.mount output
image::../assets/images/mountoutput.png[mount output]
...
.two files
image::../assets/images/twofiles.png[two files]
